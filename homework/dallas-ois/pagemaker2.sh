...
done < compciv/homework/dallas-ois/tables/incidents.psv
echo "</table>"
echo "<br /><br /><br /><br />"
echo "<h2>Officers:</h2>"
echo "<table border=\"1\" bordercolor=\"black\" cellpadding=\"2\">"
...
done < compciv/homework/dallas-ois/tables/officers.psv
echo "</table>"
echo "<br /><br /><br /><br />"
...
done < compciv/homework/dallas-ois/tables/suspects.psv
echo "</table>"
echo "</body>"
echo "</html>"
